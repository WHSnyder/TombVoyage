...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_myActions p_myActions;
        ...
        public static SteamVR_Input_ActionSet_myActions myActions
        {
            get
            {
                return SteamVR_Actions.p_myActions.GetCopy<SteamVR_Input_ActionSet_myActions>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_myActions = ((SteamVR_Input_ActionSet_myActions)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_myActions>("/actions/myActions")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.myActions};
        }
    }
}
